...
<body onLoad="mm.id.focus()">
        ...
        <div class="page-header">
    	    <h1>회원정보찾기 <small></small></h1>
        </div>
        
        <form class="form-horizontal" method="post" name="mm" action="findcheck.jsp">
        ...
        <div class="form-group">
          <div class="col-sm-12 text-center">
            ...
            <button class="btn btn-primary" type="submit">찾기<i class="fa fa-check spaceLeft"></i></button>
