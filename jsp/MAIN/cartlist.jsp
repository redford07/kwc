...
<header id="header" class="alt">
	...
	<td align="center" >
		...
		<tr > 
		<td align="center"><font >상품번호</font></td>
		...
		<%
		Vector vResult= proMgr.getCart(userid);
		if(vResult.size() ==0){
		%>
		<tr> 
		...
		<%String check = (String)session.getAttribute("userid"); if(check==null){%>
								...
								<td colspan="5" align="center"><a href="login.jsp">로그인 </a></td>
								<% } else{ %>
								<form name="delcart" method="post" action="deletecart.jsp" >
								<input type="text" name="no" placeholder="삭제 할 상품번호">
								 <button class="btn btn-primary" type="submit">장바구니 비우기<i class="fa fa-check spaceLeft"></i></button>
            
							
								</form>
								<!-- <td colspan="5" align="center"><a href="deletecart.jsp">장바구니 비우기</a></td> -->
